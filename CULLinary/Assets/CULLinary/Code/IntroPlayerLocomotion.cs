...
public class IntroPlayerLocomotion : DungeonPlayerAction {
    ...
    private void Awake()
    {
        introPlayerController = GetComponent<IntroPlayerController>();
        introPlayerController.OnPlayerMove += Move;
        introPlayerController.OnPlayerRotate += Rotate;
        introPlayerController.OnPlayerInteract += FaceWorldPosition;
    }
